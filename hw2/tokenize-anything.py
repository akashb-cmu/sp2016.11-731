...
#This code was provided by Austin Mathews (http://armatthews.com/)
...
parser.add_argument('--token_list', type=str, default='./token_list', help='List of tokens that should not be segmented')
